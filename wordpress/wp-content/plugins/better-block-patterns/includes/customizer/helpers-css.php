...
if ( ! class_exists( 'BBP_CSS' ) ) :
    ...
    class BBP_CSS {
        ...
        /**
         * The one instance of BBP_CSS.
         *
         * @var   BBP_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one BBP_CSS instance.
         *
         * @return BBP_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'bbp_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `bbp_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'bbp_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'bbp_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'bbp_get_css' ) ) :
    /**
     * Return the one BBP_CSS object.
     *
     * @return BBP_CSS    The one BBP_CSS object.
     */
    function bbp_get_css() {
        return BBP_CSS::instance();
    }
endif;

add_action( 'init', 'bbp_get_css', 1 );