...
<div class="wrap">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<div class="container post-featured-gallery <?php if($wedding_photos_boxed_gallery !=1){ echo 'boxed-gallery'; } ?> <?php echo esc_attr($blog_gallery_col) .' '. esc_attr($blog_gallery_border) .' '. esc_attr($blog_gallery_text_content). ' '. esc_attr($blog_gallery_box_layout); ?>">
				<?php
				if( have_posts() ) {
					while(have_posts() ) {
						the_post();
