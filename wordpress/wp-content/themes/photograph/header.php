				...
				<div id="sticky-header" class="clearfix">
					<div class="main-header clearfix">
						<?php do_action('photograph_site_branding'); ?>
							...
							if( (1 != $photograph_settings['photograph_disable_main_menu']) || (1 != $search_form) || (1 != $photograph_side_menu) ){  ?>
								<div class="right-toggle">
									...
									<button type="button" class="show-menu-toggle">
										<span class="sn-text"><?php esc_html_e('Menu Button','photograph'); ?></span>
				...
				<aside class="side-menu-wrap" role="complementary">
					<div class="side-menu">
						...
						if (has_nav_menu('side-nav-menu') || (has_nav_menu( 'social-link' ) && $photograph_settings['photograph_side_menu_social_icons'] == 0 ) || is_active_sidebar( 'photograph_side_menu' ) ):
							...
							<nav class="side-nav-wrap" role="navigation" aria-label="<?php esc_attr_e('Sidebar Menu','photograph');?>">
