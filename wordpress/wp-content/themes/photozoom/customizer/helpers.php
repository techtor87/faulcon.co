...
if ( ! function_exists( 'photozoom_get_pages' ) ) :
/**
 ...
 */
function photozoom_get_pages() {

    $choices = array( 0 );

    // Default
    $choices = array( 'none' => esc_html__( 'None', 'photozoom' ) );
    ...
    return apply_filters( 'photozoom_get_pages', $choices );
}
endif;

if ( ! function_exists( 'photozoom_sanitize_pages' ) ) :
/**
 ...
 */
function photozoom_sanitize_pages( $value ) {
...
if ( ! function_exists( 'photozoom_get_categories' ) ) :
/**
 ...
 */
function photozoom_get_categories() {
    ...
    return apply_filters( 'photozoom_get_categories', $choices );
}
endif;

if ( ! function_exists( 'photozoom_sanitize_categories' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function photozoom_sanitize_categories( $value ) {

    $choices = photozoom_get_categories();
    $valid   = array_keys( $choices );
